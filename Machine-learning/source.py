...
if __name__ == "__main__":
    ...
    cpp_lib.linear_model_predict_classification.argtypes = [ctypes.c_void_p,
                                                        ctypes.c_double * 1,
                                                        ctypes.c_int]
    cpp_lib.linear_model_predict_classification.restype = ctypes.c_double
    ...
    # for i in range(10):
    #     predicted_values[i] = cpp_lib.linear_model_predict_classification(model, (ctypes.c_double * 1)(*[inputs[i]]), 1)
